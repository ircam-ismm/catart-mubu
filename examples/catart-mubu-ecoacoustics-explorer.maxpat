...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 977.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 496.0, 1311.0, 547.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 176.0, 271.0, 147.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 640.0, 266.0, 67.0, 22.0 ],
									"text" : "voice 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 534.0, 266.0, 43.0, 22.0 ],
									"text" : "zl sum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 188.0, 79.0, 22.0 ],
									"text" : "prepend note"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 236.0, 159.0, 150.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 176.0, 158.0, 60.0, 22.0 ],
									"text" : "zl change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.0, 132.0, 93.5, 22.0 ],
									"text" : "pack 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 174.0, 100.0, 168.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 556.0, 320.0, 329.0, 62.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 176.0, 234.0, 531.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 540.5, 437.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 677.0, 442.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 709.0, 179.0, 107.0, 22.0 ],
									"text" : "expr $f1 / 24 * 360"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 524.0, 100.0, 24.0, 24.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 519.0, 1037.0, 360.0, 116.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 752.0, 267.0, 120.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 462.000013768672943, 344.0, 61.0, 22.0 ],
					"text" : "maximum"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 350.0, 713.0, 100.0, 22.0 ],
									"text" : "speedlim 60000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 580.000008642673492, 616.0, 22.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 12.0, 329.0, 50.0, 33.0 ],
					"text" : "re-run UMAP"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 361.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 337.0, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 313.0, 133.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 314.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 337.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 360.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 359.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 404.0, 151.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 325.0, 194.5, 184.0, 20.0 ],
					"text" : "empty"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 1719.0, 121.162391742070554, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 682.0, 224.0, 20.0 ],
					"text" : "Date/Time: 2020-01-04_06h45m34.000s",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 1715.0, 121.162391742070554, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "File: S4A09154_20200104_064500.wav"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 1715.0, 81.162391742070554, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 699.799987999999985, 122.333327999999995, 20.0 ],
					"text" : "Start: 34000.00 ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 726.0, 113.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.705115779994912, 404.0, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 52.705115779994912, 403.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"cursor_outputdata" : 0,
					"cursor_position" : [ 4732.722825427356838, -1.0 ],
					"cursor_shape" : "cross",
					"cursor_size" : 1,
					"cursor_sizeunit" : 1,
					...
					"cursor_visible" : 0,
					"dirtypatcher" : 1,
					"domain_bounds" : [ 4732.722825427356838, 8536.035313589538418 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 763.0, 45.0, 103.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2.0, 906.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 208.666672885417938, 362.666677474975586, 265.0, 18.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"slidercolor" : [ 0.549019607843137, 0.658823529411765, 0.776470588235294, 1.0 ],
					"spacing" : 1
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-46", 3 ],
					"midpoints" : [ 239.5, 1189.136277774467544, 350.160742341390574, 1189.136277774467544, 350.160742341390574, 785.967219988002739, 330.5, 785.967219988002739 ],
					"source" : [ "obj-30", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 1 ],
					"midpoints" : [ 125.5, 1202.451905647411422, 37.5, 1202.451905647411422 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"midpoints" : [ 11.5, 1193.451905647411422, 11.5, 1193.451905647411422 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 330.5, 903.466652551784478, 362.155154008980389, 903.466652551784478, 362.155154008980389, 752.159794012203179, 41.5, 752.159794012203179 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"name" : "AUPeakLimiter_20251126.maxsnap",
				"bootpath" : "~/Documents/Max 9/Snapshots",
				"patcherrelativepath" : "../../../Documents/Max 9/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
