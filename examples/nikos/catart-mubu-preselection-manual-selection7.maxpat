...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.0, 1496.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 983.0, 1360.0, 43.0, 22.0 ],
					"text" : "zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 874.301198363304138, 1592.0, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 1592.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 1562.0, 107.0, 22.0 ],
					"text" : "if $i1 >= 0 then $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 1504.0, 50.0, 22.0 ],
					"text" : "update"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 874.301198363304138, 1352.0, 40.0, 22.0 ],
					"text" : "t b b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 874.301198363304138, 1383.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 1451.0, 50.0, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 874.301198363304138, 1504.0, 42.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 874.301198363304138, 1562.0, 40.0, 22.0 ],
					"text" : "t b b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.301198363304138, 1624.0, 64.0, 22.0 ],
					"text" : "pack 1 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 874.301198363304138, 1460.0, 40.0, 22.0 ],
					"text" : "uzi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 874.301198363304138, 1411.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.301198363304138, 1658.0, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 874.301198363304138, 1699.0, 316.0, 22.0 ],
					"saved_object_attributes" : 					{
						"verbose" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"cursor_noringoffset" : 0,
					"cursor_numextracursors" : 0,
					"cursor_position" : [ 0.0, -0.079477539668061 ],
					"cursor_shape" : "cross",
					"cursor_size" : 1,
					"cursor_sizeunit" : 1,
					"cursor_symbol" : "circle",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.0, 1357.0, 43.0, 22.0 ],
					"text" : "zlclear"
				}
