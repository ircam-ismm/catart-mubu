...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 448.0, 1007.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.86328125, 1169.383714318275452, 100.0, 22.0 ],
					"text" : "zl iter 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.20929741859436, 1143.802319884300232, 50.0, 22.0 ],
					"text" : "3 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 28.86328125, 1193.802318096160889, 100.0, 22.0 ],
					"text" : "== 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.86328125, 1143.802319884300232, 100.0, 22.0 ],
					"text" : "zl sort 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.86328125, 963.8359375, 48.0, 22.0 ],
					"text" : "pipe 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.86328125, 1063.569764614105225, 43.0, 22.0 ],
					"text" : "zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.86328125, 1007.755813121795654, 42.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.86328125, 1119.383716106414795, 55.0, 23.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.86328125, 1063.569764614105225, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.86328125, 1091.47674036026001, 93.0, 22.0 ],
					"saved_object_attributes" : 					{
						"legacy" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.86328125, 1037.988370180130005, 61.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"legacy" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.86328125, 984.5, 278.649098634719849, 22.0 ],
					"text" : "t b b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.86328125, 1009.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 679.0, 43.0, 78.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 663.0, 44.0, 124.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 848.0, 41.0, 78.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 780.0, 44.0, 73.0, 20.0 ],
					"text" : "Static",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1952.0, 810.0, 158.0, 36.0 ],
					"text" : "spat5.osc.replace @initwith \"/source/1 /direction\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1796.0, 832.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 982.9273761510849, 100.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 1008.50877058506012, 100.0, 22.0 ],
					"text" : "s refminmax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 347.0, 959.0, 100.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1561.39948844909668, 816.5, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1561.39948844909668, 847.0, 66.416612863540649, 66.416612863540649 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1708.0, 717.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1796.0, 1059.0, 30.0, 30.0 ],
					"varname" : "xyzaed[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1952.0, 977.0, 90.0, 38.0 ],
					"text" : "scaling factor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1928.0, 871.0, 134.0, 79.0 ],
					"text" : "this is a variant of the hypercardioid which also supports \"focus\" or \"selectivity\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1796.0, 967.0, 170.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1796.0, 941.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1796.0, 871.0, 134.0, 64.0 ],
					"text" : "spat5.hoa.directivity @initwith \"/order 4, /pattern hypercardioidfractional\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.153867721557617, 820.000078201293945, 100.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 363.703691780567169, 865.75, 301.0, 53.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 59.872606754302979, 12.738852500915527, 325.477681398391724, 42.0 ],
					"text" : "On - Map the cursor position - only scatterplot descriptors are relevant\nOff - Map the segment position - all descriptors are relevant (needs poly for spatialising overlapping grains)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 257.153867721557617, 867.0, 36.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 7.0, 41.0, 41.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 296.0, 866.5, 48.0, 36.5 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "0", "1" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2029.0, 741.0, 138.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2029.0, 717.0, 77.0, 22.0 ],
					"text" : "/roomsize $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2029.0, 770.0, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 604.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.518503487110138, 819.999973118305206, 86.0, 22.0 ],
					"text" : "r tospatscaling"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1857.0, 810.0, 77.0, 21.0 ],
					"text" : "/selectivity $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 548.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1719.0, 802.325552701950073, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2029.0, 683.0, 151.0, 22.0 ],
					"text" : "spat5.osc.prepend /room/1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2029.0, 656.0, 94.0, 21.0 ],
					"text" : "/reverberance $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1724.0, 330.0, 68.0, 22.0 ],
					"text" : "pak 1. 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1724.0, 363.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1720.0, 496.0, 68.0, 22.0 ],
					"text" : "pak 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1719.0, 525.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1708.0, 683.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 985.416630983352661, 197.916662931442261, 78.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 568.324549317359924, 44.0, 73.0, 20.0 ],
					"text" : "Inverse",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1506.372497081756592, 414.866721391677856, 177.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 597.0, 228.0, 226.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
...
,
					"text" : "On= 0°,180° + Rand.Side I Off=0°,360°",
					"textcolor" : [ 0.269595890603871, 0.408853959740371, 0.595943257030903, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 569.0, 225.0, 26.175450682640076, 26.175450682640076 ],
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.live_selection"
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 64.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 124.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 188.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 252.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 316.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 372.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 428.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 484.0, 196.0, 22.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2029.0, 617.0, 157.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1708.0, 1059.0, 30.0, 30.0 ]
				}
