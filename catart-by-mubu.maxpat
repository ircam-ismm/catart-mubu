{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1.0, 44.0, 555.0, 773.0 ],
		"bglocked" : 0,
		"defrect" : [ 1.0, 44.0, 555.0, 773.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 545.0, 50.0, 60.0 ],
					"text" : "194 184 174 195"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 690.0, 50.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 430.0, 730.0, 84.0, 17.0 ],
					"text" : "s #2radius"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 660.0, 84.0, 17.0 ],
					"text" : "r #2radius"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 415.0, 685.0, 50.0, 20.0 ],
					"presentation_rect" : [ 416.0, 685.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 710.0, 71.0, 18.0 ],
					"presentation_rect" : [ 416.0, 710.0, 0.0, 0.0 ],
					"text" : "radius $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 680.0, 74.0, 18.0 ],
					"presentation_rect" : [ 313.0, 682.0, 0.0, 0.0 ],
					"text" : "duration 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 580.0, 79.0, 20.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 400.0, 580.0, 50.0, 20.0 ],
					"presentation_rect" : [ 401.0, 580.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 605.0, 122.0, 18.0 ],
					"presentation_rect" : [ 399.0, 607.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 125.0, 611.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 611.0, 98.0, 17.0 ],
					"presentation_rect" : [ 226.0, 610.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 611.0, 28.0, 17.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 95.0, 611.0, 29.0, 17.0 ],
					"presentation_rect" : [ 274.0, 714.0, 0.0, 0.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 315.0, 580.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 605.0, 71.0, 18.0 ],
					"text" : "duration $1"
				}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"presentation_rect" : [ 105.0, 370.0, 0.0, 0.0 ],
													"text" : "to idesc"
												}
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 391.0, 119.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 762.0, 622.0, 515.0, 354.0 ],
										"bglocked" : 0,
										"defrect" : [ 762.0, 622.0, 515.0, 354.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"patching_rect" : [ 480.0, 580.0, 293.0, 18.0 ],
									"text" : "view 0 paramcols 1 2 -1 -1 4 - - - - - 0 - 0"
								}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 309.0, 520.0, 0.0, 0.0 ],
									"text" : "mubu.track corpus 4"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 359.0, 611.0, 0.0, 0.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 232.0, 583.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 182.0, 583.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 235.0, 624.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 185.0, 624.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 100.0, 620.0, 0.0, 0.0 ]
								}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"presentation_rect" : [ 45.0, 9.0, 0.0, 0.0 ],
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 315.0, 68.0, 0.0, 0.0 ],
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 161.0, 130.0, 0.0, 0.0 ],
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 324.0, 128.0, 0.0, 0.0 ],
													"text" : "zl iter 2 4096"
												}
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 188.0, 39.0, 0.0, 0.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"presentation_rect" : [ 319.0, 97.0, 0.0, 0.0 ],
													"text" : "zl lace 4096"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 255.0, 165.0, 157.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 170.0, 660.0, 15.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 95.0, 660.0, 15.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 695.0, 85.0, 20.0 ],
					"text" : "loadmess 128"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.0, 660.0, 30.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "int" ],
					"patching_rect" : [ 140.0, 660.0, 30.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 705.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 95.0, 630.0, 390.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "mubu.knn corpus 4 @radius 0 @k 4"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"hidden" : 0,
					"midpoints" : [ 290.0, 658.5, 149.5, 658.5 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"hidden" : 0,
					"midpoints" : [ 104.5, 658.5, 119.5, 658.5 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 290.0, 658.5, 179.0, 658.5 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 409.5, 624.0, 300.0, 624.0, 300.0, 609.0, 270.0, 609.0, 270.0, 606.0, 104.5, 606.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 324.5, 624.0, 300.0, 624.0, 300.0, 609.0, 270.0, 609.0, 270.0, 606.0, 104.5, 606.0 ],
					"source" : [ "obj-8", 0 ]
				}
