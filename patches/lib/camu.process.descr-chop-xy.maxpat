...
, 			{
				"box" : 				{
					...
					"text" : "mubu.process #1 audio descr:chop:const:const @name descr @priority 2 @process 0 @progressoutput input @timetagged 1 @descr.winsize 2048 @descr.hopsize 256 @descr.minfreq 24 @chop.size 250. @chop.mean 1 @chop.stddev 1 @chop.duration 1 @const.name DistX",
