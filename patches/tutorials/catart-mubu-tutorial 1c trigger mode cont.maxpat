...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.166655999999989, 402.833344000000011, 93.0, 22.0 ],
					"text" : "camu.target"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 354.700012000000015, 80.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 408.833344000000011, 45.0, 22.0 ],
					"text" : "update"
				}
...
,
					"patching_rect" : [ 202.166655999999989, 367.700012000000015, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 208.999985000000009, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.896758999999975, 298.5, 101.103240999999997, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.0, 280.0, 91.0, 20.0 ],
					"text" : "repeat markers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.0, 255.999985000000009, 88.0, 20.0 ],
					"text" : "pause/resume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 114.0, 402.833344000000011, 61.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 208.999985000000009, 102.0, 22.0 ],
					"text" : "trigger mode..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 518.0, 53.0, 21.0 ],
					"text" : "pack 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"cursor_position" : 23.585740869966159,
					"cursor_shape" : "cross",
					"cursor_size" : 3,
					"cursor_sizeunit" : 0,
					"cursor_visible" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.666663999999997, 547.0, 363.0, 35.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.666655999999989, 518.0, 86.0, 22.0 ],
					"text" : "bufferindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.666655999999989, 469.0, 55.0, 20.0 ],
					"text" : "distance"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.666655999999989, 469.0, 73.0, 20.0 ],
					"text" : "buffer index"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.666663999999997, 469.0, 66.0, 20.0 ],
					"text" : "data index"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.666655999999989, 489.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 222.666655999999989, 489.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 164.666655999999989, 489.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 518.0, 93.0, 22.0 ],
					"text" : "markerindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 113.666663999999997, 489.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.666663999999997, 444.0, 345.999975999999947, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.833331999999928, 438.5, 65.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 255.999985000000009, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 280.0, 150.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-46", 0 ],
					"midpoints" : [ 58.5, 436.916672000000005, 123.166663999999997, 436.916672000000005 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 574.5, 679.0, 540.833374000000049, 679.0, 540.833374000000049, 357.200012000000015, 285.666655999999989, 357.200012000000015 ],
					"source" : [ "obj-216", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 232.166655999999989, 543.0, 123.166663999999997, 543.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 467.166663999999969, 592.0, 558.416659999999979, 592.0, 558.416659999999979, 337.700012000000015, 184.5, 337.700012000000015 ],
					"source" : [ "obj-30", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 327.5, 544.0, 547.25, 544.0, 547.25, 348.200012000000015, 248.666655999999989, 348.200012000000015 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 123.5, 285.0, 106.666672000000005, 285.0, 106.666672000000005, 543.333374000000049, 123.166663999999997, 543.333374000000049 ],
					"source" : [ "obj-81", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 211.5, 338.349976000000026, 211.666655999999989, 338.349976000000026 ],
					"order" : 1,
					"source" : [ "obj-81", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-216", 0 ],
					"midpoints" : [ 285.666655999999989, 397.200012000000015, 552.333374000000049, 397.200012000000015, 552.333374000000049, 158.333327999999995, 574.5, 158.333327999999995 ],
					"source" : [ "obj-95", 1 ]
				}
