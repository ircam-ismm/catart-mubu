...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 201.700012000000015, 122.0, 22.0 ],
					"text" : "r #1-process"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 161.0, 91.700011999999987, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 90.900024000000002, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1.0, 91.700011999999987, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 90.900024000000002, 150.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 14.0, 285.700012000000015, 259.0, 20.0 ],
					"restore" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 14.0, 264.700012000000015, 240.0, 20.0 ],
					"restore" : [ 150.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 923.5, 322.700012000000015, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "int", "" ],
					"patching_rect" : [ 392.0, 255.700012000000015, 550.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 322.700012000000015, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "> Attributes: mfcc-chop (corpus)"
				}
