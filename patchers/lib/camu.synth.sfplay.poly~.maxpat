...
,
		"classnamespace" : "box",
		"rect" : [ 2000.0, 87.0, 1180.0, 1070.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 192.000005722045898, 319.333342850208282, 23.0, 22.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.333342134952545, 281.333341717720032, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 539.0, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 295.333342134952545, 406.000012099742889, 39.0, 22.0 ],
					"text" : "- 100."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 268.0000079870224, 347.333343684673309, 46.0, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 268.0000079870224, 468.000013947486877, 48.0, 22.0 ],
					"text" : "delay"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 604.5, 110.0, 22.0 ],
					"text" : "mc.unpack~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 418.0, -335.0, 64.0, 22.0 ],
					"text" : "play $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 576.5, 110.0, 22.0 ],
					"text" : "mc.*~ 1. @chans 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.154638886451721, -237.113388776779175, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 278.0, 500.5, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 278.0, 538.5, 64.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 278.0, 464.0, 100.0, 22.0 ],
									"text" : "route notfound"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 278.0, 425.5, 100.0, 22.0 ],
									"text" : "absolutepath"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 278.0, 597.0, 105.0, 22.0 ],
									"text" : "regexp \\\\.wav .flac"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 644.0, 344.0, 153.0, 33.0 ],
									"text" : "not found with path: try filename in search path"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 256.0, 272.0, 153.0, 33.0 ],
									"text" : "in case of missing filepath: force output"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 615.0, 348.5, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 615.0, 386.5, 64.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 479.0, 386.5, 100.0, 22.0 ],
									"text" : "route notfound"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 411.0, 268.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 479.0, 348.0, 100.0, 22.0 ],
									"text" : "absolutepath"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 560.0, 425.5, 128.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 479.0, 268.0, 303.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 722.0, 420.0, 152.0, 33.0 ],
...
,
					"patching_rect" : [ 5.0, 197.0, 219.587616562843323, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 204.0, 163.850005745887756, 54.0, 20.0 ],
					"text" : "delayvar"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 149.0, 162.850005745887756, 50.0, 22.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 221.605229184043878, 54.0, 22.0 ],
									"text" : "delay $1"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "route pan panvar spread play channels delayvar xfade"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 694.5, -174.850511074066162, 694.5, -174.850511074066162 ],
					"source" : [ "obj-42", 0 ]
				}
