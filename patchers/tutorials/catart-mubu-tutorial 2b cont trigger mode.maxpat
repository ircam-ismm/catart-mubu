...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 472.416663999999969, 576.0, 35.0, 91.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 502.416663999999969, 617.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 506.416663999999969, 576.5, 59.0, 39.0 ],
					"text" : "audio on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.666655999999989, 188.5, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 208.999985000000009, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.25, 232.999985000000009, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 227.0, 232.999985000000009, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.948379499999987, 298.5, 101.103240999999997, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.948379499999987, 280.0, 91.0, 20.0 ],
					"text" : "repeat grains"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.948379499999987, 255.999985000000038, 88.0, 20.0 ],
					"text" : "pause/resume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 208.999985000000009, 110.0, 22.0 ],
					"text" : "trigger mode..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 446.468286499999977, 145.0, 114.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"cursor_position" : 2548.678903739211819,
					"cursor_shape" : "cross",
					"cursor_size" : 3,
					"cursor_sizeunit" : 0,
					"cursor_visible" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.039780000000007, 173.0, 161.0, 20.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 114.0, 232.999985000000009, 89.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.666663999999997, 226.999985000000038, 74.0, 42.0 ],
					"text" : "trigger modes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.666655999999989, 556.0, 55.0, 20.0 ],
					"text" : "distance"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.666655999999989, 576.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.833331999999928, 525.5, 90.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 446.468286499999977, 124.499985000000038, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.0, 255.999985000000009, 200.0, 22.0 ],
					"text_width" : 174.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 495.833344000000011, 79.0, 20.0 ],
					"text" : "target values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.158786499999962, 205.0, 466.515755000000013, 233.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 417.317565999999999, 228.0, 183.349090999999987, 94.0 ],
					"proportion" : 0.39,
					"rounded" : 24
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 506.480090999999902, 554.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 574.5, 679.0, 558.833374000000049, 679.0, 558.833374000000049, 455.460878343975082, 197.166663999999997, 455.460878343975082 ],
					"source" : [ "obj-216", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 467.166663999999969, 679.0, 93.166659999999979, 679.0, 93.166659999999979, 363.0, 271.5, 363.0 ],
					"source" : [ "obj-30", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 327.5, 631.0, 547.25, 631.0, 547.25, 453.200012000000015, 160.166663999999997, 453.200012000000015 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.5, 0.0, 1.0 ],
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 271.5, 567.511068284511566, 232.166655999999989, 567.511068284511566 ],
					"source" : [ "obj-57", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.5, 0.0, 1.0 ],
					"destination" : [ "obj-45", 0 ],
					"midpoints" : [ 123.5, 445.0, 99.0, 445.0, 99.0, 570.0, 123.166663999999997, 570.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 225.5, 197.0, 235.269896999999986, 197.0, 235.269896999999986, 163.0, 248.539780000000007, 163.0 ],
					"source" : [ "obj-69", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 110.0, 285.0, 106.666672000000005, 285.0, 106.666672000000005, 631.333374000000049, 123.166663999999997, 631.333374000000049 ],
					"source" : [ "obj-81", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 198.0, 302.999992500000019, 123.5, 302.999992500000019 ],
					"source" : [ "obj-81", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 236.5, 262.0, 91.0, 262.0, 91.0, 455.130429565906525, 123.166663999999997, 455.130429565906525 ],
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-216", 0 ],
					"hidden" : 1,
					"midpoints" : [ 197.166663999999997, 490.504356832897201, 552.333374000000049, 490.504356832897201, 552.333374000000049, 158.333327999999995, 574.5, 158.333327999999995 ],
					"source" : [ "obj-95", 1 ]
				}
