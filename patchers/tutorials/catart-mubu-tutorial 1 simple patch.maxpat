...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 501.0, 131.0, 20.0 ],
					"text" : "highlight selected point"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 3.125, 105.75, 105.75 ],
					"pic" : "icon.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 219.0, 120.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 224.0, 45.0, 22.0 ],
					"text" : "update"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 274.0, 156.0, 20.0 ],
					"text" : "interface with imubu display"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 402.0, 79.0, 20.0 ],
					"text" : "target values",
...
, 			{
				"box" : 				{
					"args" : [ "tut1-corpus", "descr", "opacity" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "tut1-corpus", "descr", "color", "FrequencyMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "tut1-corpus", "descr", "size", "LoudnessMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.5, 88.5, 75.0, 37.0 ],
					"text" : "load corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 535.0, 53.0, 21.0 ],
					"text" : "pack 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"cursor_position" : 818.784357628478574,
					"cursor_shape" : "cross",
					"cursor_size" : 3,
					"cursor_sizeunit" : 0,
					"cursor_visible" : 1,
					"domain_bounds" : [ 64.844202277220646, 2054.034522869155353 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 432.0, 88.0, 26.0 ],
					"text" : "selection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 572.0, 92.0, 26.0 ],
					"text" : "synthesis"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 514.0, 321.600006000000121, 209.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 248.0, 47.5, 121.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 409.0, 320.600006000000064, 100.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "mubu.process tut1-corpus audio descr:chop @name descr @process 0 @progressoutput input @timetagged 1 @descr.winsize 3420 @descr.moments 2 @chop.size 145 @chop.mean 1"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 397.0, 75.0, 26.0 ],
					"text" : "control"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 595.0, 103.5, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 573.0, 101.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 151.0, 102.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"externalfiles" : 1,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 5.25, 409.0, 33.0 ],
					"text" : "CataRT-MuBu — Simplest Patch"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 114.0, 618.0, 32.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 572.0, 368.0, 35.0 ],
					"saved_object_attributes" : 					{
						"outputstate" : 0,
						"resampleaudioinput" : 0
					}
,
					"text" : "mubu.concat~ 2 tut1-corpus @audio audio @markers descr @play 0 @autotrigger 1 @duplicatechannels 1 @allowrepeatmarkers 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 535.0, 86.0, 22.0 ],
					"text" : "bufferindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 469.0, 55.0, 20.0 ],
					"text" : "distance",
					"textcolor" : [ 1.0, 0.5, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 469.0, 73.0, 20.0 ],
					"text" : "buffer index",
					"textcolor" : [ 1.0, 0.5, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 469.0, 66.0, 20.0 ],
					"text" : "data index",
					"textcolor" : [ 1.0, 0.5, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 331.0, 489.0, 72.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 223.0, 489.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 489.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 535.0, 93.0, 22.0 ],
					"text" : "markerindex $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 114.0, 489.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 439.0, 344.49998800000003, 22.0 ],
					"text" : "mubu.knn tut1-corpus descr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 439.0, 57.0, 33.0 ],
...
,
					"patching_rect" : [ 569.0, 131.0, 87.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 464.5, 88.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 424.5, 195.499985000000066, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 38.666662000000002, 402.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 401.0, 397.0, 93.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 402.0, 73.0, 21.0 ],
					"text" : "select $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 402.0, 83.0, 21.0 ],
					"text" : "columns $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 224.0, 59.166668000000001, 19.0 ],
					"text" : "pak 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 356.0, 167.0, 47.0 ],
					"text" : "listen for mouse move coordinates (for click mode, use mouse down)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 147.0, 333.0, 93.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 147.0, 304.0, 69.0, 21.0 ],
					"text" : "route mouse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.0, 523.0, 110.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 460.0, 141.0, 67.0, 22.0 ],
					"text" : "unpack 5 2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, 105.0, 249.0, 33.0 ],
									"text" : "this is the most simple UI for descr. selection.\nSee camu.menu for a complete solution."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 74.0, 425.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 153.0, 189.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 239.0, 294.0, 79.199996999999996, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, 376.0, 73.0, 20.0 ],
									"text" : "descr. index"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 273.0, 42.0, 21.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 133.0, 347.0, 20.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 38.0, 0.0, 20.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 74.0, 308.0, 156.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 59.0, 0.0, 156.0, 22.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 74.0, 347.0, 53.0, 22.0 ],
									"presentation" : 1,
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 83.5, 286.666655999999875, 83.5, 286.666655999999875 ],
									"source" : [ "obj-139", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 83.5, 395.318999749999989, 46.375, 395.318999749999989, 46.375, 256.854155999999875, 83.5, 256.854155999999875 ],
									"order" : 2,
									"source" : [ "obj-142", 0 ]
								}
...
,
					"patching_rect" : [ 573.0, 67.0, 228.0, 24.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 573.0, 22.0, 228.0, 24.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 727.0, 45.5, 132.0, 21.0 ],
					"text" : "view descr paramcol x $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 46.0, 130.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 41.0, 130.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 0.0, 130.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, -5.0, 130.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 44.0, 76.0, 247.0, 22.0 ],
									"text" : "t b clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.0, 257.0, 62.0, 21.0 ],
									"text" : "append $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.0, 205.0, 32.5, 21.0 ],
									"text" : "iter"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 304.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 42.0, 174.0, 115.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 108.0, 102.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 44.0, 141.0, 210.0, 21.0 ],
									"saved_object_attributes" : 									{
										"verbose" : 1
									}
,
									"text" : "mubu.track tut1-corpus descr"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 281.5, 292.10546875, 51.5, 292.10546875 ],
									"source" : [ "obj-30", 1 ]
								}
...
,
					"patching_rect" : [ 483.0, 162.0, 78.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.0, 94.5, 132.0, 21.0 ],
					"text" : "view descr paramcol y $1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-216", 0 ],
					"hidden" : 1,
					"midpoints" : [ 418.5, 563.55078125, 539.33203125, 563.55078125, 539.33203125, 151.0, 574.5, 151.0 ],
					"source" : [ "obj-209", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 574.5, 679.0, 552.3359375, 679.0, 552.3359375, 296.86328125, 156.5, 296.86328125 ],
					"source" : [ "obj-216", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 232.5, 568.0, 123.5, 568.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 232.5, 526.5, 361.5, 526.5 ],
					"order" : 0,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 298.0, 613.19921875, 136.5, 613.19921875 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 123.5, 586.0, 123.5, 586.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 123.5, 526.5, 327.5, 526.5 ],
					"order" : 0,
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 1,
					"midpoints" : [ 123.5, 212.86328125, 443.0, 212.86328125, 443.0, 4.0, 582.5, 4.0 ],
					"order" : 0,
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 123.5, 214.749992500000019, 123.5, 214.749992500000019 ],
					"order" : 1,
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-8::obj-141" : [ "umenu[6]", "DescrName", 0 ],
			"obj-9::obj-141" : [ "umenu[8]", "DescrName", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
