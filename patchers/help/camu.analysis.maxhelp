{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 10.0, 96.8000014424324, 60.0, 22.0 ],
                    "text": "deferlow"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 612.0, 460.0, 29.5, 22.0 ],
                    "text": "set"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 612.0, 434.0, 61.0, 22.0 ],
                    "text": "savebang"
                }
            },
            {
                "box": {
                    ...
                    "text": "presents an internal menu for choices of analysis and segmentation and dynamically loads the corresponding camu.process.<choice>.maxpat in a bpatcher to show the analysis parameters."
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 520.0, 356.0, 75.0, 22.0 ],
                    "text": "descr-chop"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 499.0, 325.0, 75.0, 22.0 ],
                    "text": "descr-onseg"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int", "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 390.0, 325.0, 96.0, 22.0 ],
                    "pattrmode": 1,
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 390.0, 293.0, 52.0, 22.0 ],
                    "text": "dump, 2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 390.0, 264.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 135.0, 441.0, 99.0, 33.0 ],
                    "text": "bang when all buffers done"
                }
            },
            {
                "box": {
                    ...
                    "text": "audio descriptor analysis and segmentation container and interface"
                }
            },
            {
                "box": {
                    ...
                    "id": "obj-25",
                    "ignoreclick": 1,
                    "jsarguments": [ "camu.analysis" ],
                    "maxclass": "jsui",
                    "numinlets": 1,
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 10.0, 10.0, 360.1678466796875, 57.599853515625 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 604.0, 534.4999849999999, 105.0, 47.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 604.0, 487.0, 91.0, 35.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 133.0, 504.4999849999999, 115.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 114.0, 534.4999849999999, 219.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 253.0, 504.4999849999999, 67.0, 22.0 ],
                    "text": "pvar editor"
                }
            },
            {
                "box": {
                    "args": [ "analysis-help-corpus", "descr", "color", "FrequencyMean" ],
                    "bgmode": 0,
                    "border": 0,
                    "clickthrough": 0,
                    "enablehscroll": 0,
            ...
            {
                "box": {
                    "args": [ "analysis-help-corpus", "descr", "size", "LoudnessMean" ],
                    "bgmode": 0,
                    "border": 0,
                    "clickthrough": 0,
                    "enablehscroll": 0,
            ...
            {
                "box": {
                    "args": [ "analysis-help-corpus", "descr", "y", "PeriodicityMean" ],
                    "bgmode": 0,
                    "border": 0,
                    "clickthrough": 0,
                    "enablehscroll": 0,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 276.0, 138.0, 286.0, 22.0 ],
                    "text": "readfolder @name audio @recursive 1 @type audio"
                }
            },
            {
                "box": {
                    "args": [ "analysis-help-corpus", "descr", "x", "CentroidMean" ],
                    "bgmode": 0,
                    "border": 0,
                    "clickthrough": 0,
                    "enablehscroll": 0,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 10.0, 69.599853515625, 60.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 10.0, 124.0, 269.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "cursor_outputdata": 0,
                    "cursor_position": [ 2560.929621671665, 0.1349324636758526 ],
                    "cursor_shape": "cross",
                    "cursor_size": 1.0,
                    "cursor_sizeunit": 1,
                    ...
                    "cursor_visible": 1,
                    "dirtypatcher": 1,
                    "domain_bounds": [ 1783.5929807026632, 4033.010885506711 ],
                    ...
                    "outputviewname": 0,
                    "parameter_enable": 0,
                    "patching_rect": [ 708.0, 166.49998500000004, 500.5, 471.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 276.0, 167.0, 49.0, 22.0 ],
                    "text": "clearall"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "" ],
                    "patching_rect": [ 114.0, 404.0, 348.0, 26.0 ],
                    "text": "camu.analysis analysis-help-corpus audio descr",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 38.0, 167.0, 67.0, 22.0 ],
                    "text": "print mubu"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 4.0, 347.0, 118.0, 78.0 ],
                    "text": "double click to open interface (provided by camu.process.* bpatcher)"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 743.5, 118.49998500000004, 110.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 714.0, 118.49998500000004, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 114.0, 138.0, 153.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "text": "mubu analysis-help-corpus"
                }
            },
            {
                "box": {
                    ...
                    "parameter_enable": 1,
                    "patching_rect": [ 114.0, 611.4999849999999, 82.0, 26.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 2,
                    "numoutlets": 0,
                    "patching_rect": [ 60.0, 580.4999849999999, 45.0, 45.0 ]
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 114.0, 567.4999849999999, 437.0, 35.0 ],
                    "saved_object_attributes": {
                        "outputstate": 1,
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "s analysis-help-corpus-refresh"
                                }
                            },
                            {
                                "box": {
                    ...
                    "patching_rect": [ 714.0, 142.49998500000004, 87.0, 22.0 ],
                    "text": "p imubu-setup"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 647.0, 81.0, 51.0, 19.0 ],
                    "text": "pak 0 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 464.0, 441.0, 143.0, 22.0 ]
                }
            }
        ],
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "hidden": 1,
                    "midpoints": [ 323.5, 561.9625529850578, 350.046875, 561.9625529850578, 350.046875, 476.09565799253073, 174.5, 476.09565799253073 ],
                    "source": [ "obj-167", 1 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "hidden": 1,
                    "midpoints": [ 142.5, 530.5095742387942, 123.5, 530.5095742387942 ],
                    "source": [ "obj-175", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "hidden": 1,
                    "midpoints": [ 656.5, 491.1952682537365, 206.5, 491.1952682537365 ],
                    "source": [ "obj-225", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 541.5, 616.7187349999999, 561.66442125, 616.7187349999999, 561.66442125, 525.4469032812538, 323.5, 525.4469032812538 ],
                    "source": [ "obj-30", 2 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 332.5, 606.8632662499999, 186.5, 606.8632662499999 ],
                    "source": [ "obj-30", 1 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 123.5, 606.9999849999999, 123.5, 606.9999849999999 ],
                    "source": [ "obj-30", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-69", 0 ],
                    "midpoints": [ 123.5, 284.0, 123.5, 284.0 ],
                    "order": 0,
                    "source": [ "obj-6", 0 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 452.5, 440.25, 452.5, 440.25 ],
                    "order": 1,
                    "source": [ "obj-69", 1 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-167", 0 ],
                    "midpoints": [ 123.5, 442.5, 123.5, 442.5 ],
                    "order": 1,
                    "source": [ "obj-69", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 123.5, 494.53515625, 698.67578125, 494.53515625, 698.67578125, 108.49998500000004, 723.5, 108.49998500000004 ],
                    "order": 0,
                    "source": [ "obj-69", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-167", 0 ],
                    "hidden": 1,
                    "midpoints": [ 613.5, 532.2947304887942, 123.5, 532.2947304887942 ],
                    "source": [ "obj-7", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-30", 0 ],
                    "hidden": 1,
                    "midpoints": [ 649.5, 549.4999849999999, 123.5, 549.4999849999999 ],
                    "source": [ "obj-7", 1 ]
                }
            },
            {
        ...
        "parameters": {
            "obj-167::obj-34": [ "number", "Chance", 0 ],
            "obj-167::obj-56": [ "reverseprob", "reverseprob", 0 ],
            "obj-167::obj-82": [ "umenu[6]", "Trigger", 0 ],
