...
, 			{
				"box" : 				{
					...
					"text" : "UI module to tag soundfiles by user-defined key-value pairs (works with camu.key.select). Also can be used as a bpatcher"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-36",
					"ignoreclick" : 1,
					"jsarguments" : [ "camu.key.value" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 388.9678955078125, 57.599853515625 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "camu.key.select key-value-corpus",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.666663999999969, 91.0, 69.0, 37.0 ],
					"text" : "load corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.666663999999997, 223.5, 215.0, 24.0 ],
					"text" : "camu.key.value key-value-corpus",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.666663999999997, 305.999985000000038, 88.0, 20.0 ],
					"text" : "trigger mode..."
				}
...
, 			{
				"box" : 				{
					"args" : [ "key-value-corpus", "descr", "color", "FrequencyMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "key-value-corpus", "descr", "size", "LoudnessMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "key-value-corpus", "descr", "y", "PeriodicityMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.166663999999969, 127.0, 286.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "key-value-corpus", "descr", "x", "CentroidMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 101.0, 269.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"cursor_position" : [ 3079.536138760699032, 0.261166048135381 ],
					"cursor_shape" : "cross",
					"cursor_size" : 1,
					"cursor_sizeunit" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "mubu.process key-value-corpus audio descr:chop @name descr @process 0 @progressoutput input @timetagged 1 @descr.winsize 3420 @descr.moments 2 @chop.size 145 @chop.mean 1",
...
,
					"patching_rect" : [ 129.666663999999997, 186.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 127.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.666663999999997, 159.0, 46.0, 22.0 ],
					"text" : "printall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 159.0, 133.0, 22.0 ],
					"saved_object_attributes" : 					{
						"dirtypatcher" : 1,
						"embed" : 0,
						"externalfiles" : 1,
...
,
					"text" : "mubu.concat~ 2 key-value-corpus @audio audio @markers descr @play 0 @autotrigger 1 @duplicatechannels 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.666663999999997, 412.0, 323.0, 24.0 ],
					"text" : "mubu.knn key-value-corpus descr @radius 0 @k 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 534.0, 197.275269000000009, 195.0, 22.0 ],
									"saved_object_attributes" : 									{
										"verbose" : 1
									}
,
									"text" : "mubu.track key-value-corpus descr"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 278.0, 151.0, 22.0 ],
									"text" : "s key-value-corpus-refresh"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 251.666663999999997, 186.0, 121.0, 19.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"slidercolor" : [ 0.516304, 0.516304, 0.516304, 1.0 ],
					"spacing" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.166663999999969, 213.474953881168403, 235.0, 90.525031118831578 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 455.666663999999969, 101.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 123.166663999999997, 257.5, 33.166663999999997, 257.5, 33.166663999999997, 153.0, 123.166663999999997, 153.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 224.49999733333334, 439.0, 159.611111999999991, 439.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 427.166663999999969, 474.0, 542.666663999999969, 474.0, 542.666663999999969, 380.800000000000011, 123.166663999999997, 380.800000000000011 ],
					"source" : [ "obj-46", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 1,
					"midpoints" : [ 139.166663999999997, 218.0, 123.166663999999969, 218.0, 123.166663999999969, 189.499985000000009, 261.166663999999969, 189.499985000000009 ],
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 241.166663999999997, 193.0, 552.0, 193.0, 552.0, 103.0, 580.5, 103.0 ],
					"order" : 0,
					"source" : [ "obj-69", 1 ]
				}
