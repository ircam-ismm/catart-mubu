...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.0, 463.0, 70.0, 22.0 ],
					"text" : "loadmess 3"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-50",
					"ignoreclick" : 1,
					"jsarguments" : [ "camu.taboo" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 319.319854736328125, 57.599853515625 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 538.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 515.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 515.5, 81.0, 22.0 ],
					"text" : "camu.taboo 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.25, 538.5, 101.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.25, 515.500000000000114, 103.0, 22.0 ],
					"text" : "taboo length",
					"textcolor" : [ 1.0, 0.5, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "type" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "opacity" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "color", "FrequencyMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "size", "LoudnessMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "y", "PeriodicityMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "taboo-help-corpus", "descr", "x", "CentroidMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"cursor_position" : [ 1804.690217027338122, 0.112295286970967 ],
					"cursor_shape" : "cross",
					"cursor_size" : 3,
					"cursor_sizeunit" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.5, 237.000014999999962, 89.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 85.5, 261.000014999999962, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.039779999999951, 156.0, 49.0, 22.0 ],
					"text" : "clearall"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "int", "" ],
									"patching_rect" : [ 10.0, 177.0, 503.0, 60.0 ],
									"text" : "mubu.process taboo-help-corpus audio descr:chop @name descr @process 0 @progressoutput input @timetagged 1 @descr.winsize 3420 @descr.moments 2 @chop.size 145 @chop.mean 1",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.25, 156.0, 46.0, 22.0 ],
					"text" : "printall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 156.0, 139.0, 22.0 ],
					"saved_object_attributes" : 					{
						"dirtypatcher" : 1,
						"embed" : 0,
						"externalfiles" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 513.500000000000114, 74.0, 26.0 ],
					"text" : "taboo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.666663999999997, 634.0, 330.0, 49.0 ],
					"saved_object_attributes" : 					{
						"outputstate" : 0,
...
,
					"text" : "mubu.concat~ 2 taboo-help-corpus @audio audio @markers descr @play 0 @autotrigger 1 @duplicatechannels 1 @varmetro 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 379.799987999999985, 194.0, 22.0 ],
					"text" : "mubu.knn taboo-help-corpus descr"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 278.0, 163.0, 22.0 ],
									"text" : "s camu-taboo-corpus-refresh"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.166663999999969, 489.5, 282.833336000000031, 93.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 232.499991999999992, 477.0, 154.5, 477.0 ],
					"order" : 1,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 278.666663999999969, 679.0, 467.551618500000018, 679.0, 467.551618500000018, 567.0, 490.936573000000067, 567.0 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.990418910980225, 0.500286102294922, 0.032855201512575, 1.0 ],
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 154.5, 592.149993999999992, 230.5, 592.149993999999992 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 123.5, 212.0, 446.0, 212.0, 446.0, 6.0, 566.166687000000024, 6.0 ],
					"order" : 0,
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 95.0, 631.000007500000038, 123.166663999999997, 631.000007500000038 ],
					"source" : [ "obj-81", 0 ]
				}
