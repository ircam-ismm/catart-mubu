...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 53.666663999999997, 107.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.666663999999997, 59.5, 395.0, 38.0 ],
					"text" : "Tag soundfiles by directory name. UI version incorporated in camu.key.value and both modules work with camu.key.select"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-36",
					"ignoreclick" : 1,
					"jsarguments" : [ "camu.key.soundset" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 470.59185791015625, 57.599853515625 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.666655999999989, 218.5, 175.0, 37.0 ],
					"text" : "tag buffers automatically by directory"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.666655999999989, 261.5, 172.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "camu.key.select key-soundset-corpus",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.666663999999969, 97.0, 69.0, 37.0 ],
					"text" : "load corpus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 117.666663999999997, 218.5, 138.999999999999972, 40.0 ],
					"text" : "camu.key.soundset key-soundset-corpus",
					"varname" : "select-by-key[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.666663999999997, 305.999985000000038, 88.0, 20.0 ],
					"text" : "trigger mode..."
				}
...
, 			{
				"box" : 				{
					"args" : [ "key-soundset-corpus", "descr", "color", "FrequencyMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "key-soundset-corpus", "descr", "size", "LoudnessMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "key-soundset-corpus", "descr", "y", "PeriodicityMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.166663999999969, 133.0, 286.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "key-soundset-corpus", "descr", "x", "CentroidMean" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 107.0, 269.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "mubu.process key-soundset-corpus audio descr:chop @name descr @process 0 @progressoutput input @timetagged 1 @descr.winsize 3420 @descr.moments 2 @chop.size 145 @chop.mean 1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.666663999999997, 159.0, 67.0, 22.0 ],
					"text" : "print mubu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 133.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.166663999999969, 159.0, 46.0, 22.0 ],
					"text" : "printall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.666663999999997, 159.0, 153.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"externalfiles" : 1,
						"parameter_enable" : 0,
...
,
					"text" : "mubu.concat~ 2 key-soundset-corpus @audio audio @markers descr @play 0 @autotrigger 1 @duplicatechannels 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.666663999999997, 412.0, 347.0, 24.0 ],
					"text" : "mubu.knn key-soundset-corpus descr @radius 0 @k 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 534.0, 197.275269000000009, 215.0, 22.0 ],
									"saved_object_attributes" : 									{
										"verbose" : 1
									}
,
									"text" : "mubu.track key-soundset-corpus descr"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 278.0, 171.0, 22.0 ],
									"text" : "s key-soundset-corpus-refresh"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 514.666655999999989, 227.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 514.666655999999989, 283.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "5",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.166663999999969, 213.474953881168403, 235.0, 97.025046118831597 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 455.666663999999969, 107.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 127.166663999999997, 261.5, 558.833331999999928, 261.5, 558.833331999999928, 113.0, 580.5, 113.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 232.49999733333334, 439.0, 159.611111999999991, 439.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 451.166663999999969, 474.0, 542.666663999999969, 474.0, 542.666663999999969, 380.800000000000011, 123.166663999999997, 380.800000000000011 ],
					"source" : [ "obj-46", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.990415692329407, 0.500269114971161, 0.032865822315216, 1.0 ],
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 225.166663999999997, 210.75, 127.166663999999997, 210.75 ],
					"order" : 2,
					"source" : [ "obj-69", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 1,
					"midpoints" : [ 225.166663999999997, 210.0, 559.0, 210.0, 559.0, 113.0, 580.5, 113.0 ],
					"order" : 0,
					"source" : [ "obj-69", 1 ]
				}
